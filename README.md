...
|0~10|씨앗|seed.png|
|11~30|새싹|sprout.png|
|31~60|줄기 성장|stem.png|
|61~100|꽃 피움|flower.png|
|101 이상|열매 맺음|fruit.png|
...
|모듈 이름|역할|
|---|---|
|`MainUI`|메인 타이머 + 식물 이미지 UI|
|`TaskManager`|과제 등록/관리|
|`TimerEngine`|타이머 로직|
|`GrowthSystem`|포인트 계산 + 이미지 변경|
|`DataStorage`|사용자 정보 저장/불러오기|
|`AlertSystem`|미사용 감지 및 경고 출력|
