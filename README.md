...
# junit으로 활용한 코드 테스트 결과 요약


로그인 테스트	user / 1111 입력 시 로그인 성공
타이머 작동	시작하면 초 단위로 증가, 식물 상태 변화 확인 가능
저장 기능	타이머 종료 시 study_log.csv에 기록 저장됨
불러오기 기능	저장된 CSV 내용을 표로 보여줌
삭제 기능	모든 기록 초기화 가능 (확인창 있음)
방치 감지 기능	30초간 입력 없으면 "😴 방치 중" 표시
